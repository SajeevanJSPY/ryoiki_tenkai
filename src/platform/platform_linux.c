...
// TODO: add wayland wsi implementation as well...
...
void platform_get_presentation_surface(VkInstance instance, platform_state *plat_state, VkSurfaceKHR *surface) {
    ...
    RASSERT_MSG(vkCreateXcbSurfaceKHR(instance, &surface_create_info, NULL, surface) == VK_SUCCESS, "failed to create presentation surface");
}
